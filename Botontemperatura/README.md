...
- Conexión de los LEDs: Utiliza cables jumper para conectar los LEDs a los pines GPIO 18,GPIO 21, GPIO 22 del Raspberry Pi Pico W. 

- Conexión del botón: Conecta el pin de entrada GPIO 27 al botón de la protoboard usando un cable jumper.
